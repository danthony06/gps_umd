#ifndef GPSD_CLIENT_GPSD_PARSER_V9_HPP_
#define GPSD_CLIENT_GPSD_PARSER_V9_HPP_
...
//};
//
//GpsdParserImpl::GpsdParserImpl(const std::string& host, const int port)
//{
...
//}
//
//int8_t GpsdParserImpl::map_freq(const int8_t gnss_id, const int8_t freq_id)
//{
//  int8_t ret_value = gps_msgs::msg::GNSSSatellite::SIG_ID_UNKNOWN;
//
//  const std::map<int8_t, std::map<int8_t, int8_t>> freq_map =
